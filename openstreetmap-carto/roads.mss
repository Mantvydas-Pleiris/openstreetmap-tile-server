...
@tertiary-fill: @s-r;
@residential-fill: @s-r;
@service-fill: @residential-fill;
@living-street-fill: @s-r;
@pedestrian-fill: @s-r;
@raceway-fill: @s-r;
@road-fill: @s-r;
@footway-fill: @s-r;
@footway-fill-noaccess: @s-r;
@steps-fill: @footway-fill;
@steps-fill-noaccess: @s-r;
@cycleway-fill: @s-r;
@cycleway-fill-noaccess: @s-r;
@bridleway-fill: @s-r;
@bridleway-fill-noaccess: @s-r;
@track-fill: @s-r;
@track-fill-noaccess: @s-r;
@aeroway-fill: @s-r;
@runway-fill: @aeroway-fill;
@taxiway-fill: @aeroway-fill;
@helipad-fill: @aeroway-fill;
@access-marking: @s-r;
@access-marking-living-street: @s-r;

@default-casing: @s-r;
@tertiary-casing: @s-r;
@residential-casing: @s-r;
@road-casing: @residential-casing;
@service-casing: @residential-casing;
@living-street-casing: @residential-casing;
@pedestrian-casing: @s-r;
...
@minor-construction: @s-r;
@service-construction: @s-r;

@destination-marking: @s-r;
@private-marking: @s-r;
@private-marking-for-red: @s-r;
...
#tunnels[zoom >= 10] {
  ...
  ::fill {
    ...
    [feature = 'railway_INT-spur-siding-yard'][zoom >= 13] {
      ...
      [zoom >= 12] {
        #roads-fill, #bridges {
          ...
          light/line-color: black;
          light/line-join: round;
          [feature = 'railway_rail'] {
            dark/line-color: darken(@s-r, 15%);
            dark/line-width: 2;
    ...
    [feature = 'railway_narrow_gauge'] {
      [zoom >= 8] {
        line-color: @s-r;
        [zoom >= 10] { line-color: @s-r; }
        [zoom >= 13] { line-color: @s-r; }
        line-width: 1;
        [zoom >= 13] { line-width: 2; }
        #tunnels {
          line-dasharray: 5,3;
...
#roads-text-name {
  ...
  [highway = 'construction'][construction = 'primary'] {
    [zoom >= 13] {
      ...
      [tunnel = 'no'] {
        text-halo-radius: @standard-halo-radius;
        [highway = 'motorway'] { text-halo-fill: @s-to; }
        [highway = 'trunk'] { text-halo-fill: @s-to; }
        [highway = 'primary'] { text-halo-fill: @s-to; }
      }
    }
    [zoom >= 14] {
      text-size: 9;
  ...
  [highway = 'construction'][construction = 'service'][zoom >= 17] {
    [zoom >= 16] {
      ...
      text-placement: line;
      text-halo-radius: @standard-halo-radius;
      [highway = 'raceway'] { text-halo-fill: @s-to; }
      [highway = 'service'] { text-halo-fill: @s-to; }
      text-face-name: @book-fonts;
      text-repeat-distance: @major-highway-text-repeat-distance;
    }
    [zoom >= 17] {
  ...
  [highway = 'construction'][construction = 'pedestrian'][zoom >= 16] {
    [zoom >= 15] {
      ...
      [highway = 'pedestrian'] { text-halo-fill: @s-to; }
      text-face-name: @book-fonts;
      text-repeat-distance: @minor-highway-text-repeat-distance;
    }
    [zoom >= 16] {
