...
@grass: @s-l;        // Lch(90,32,128) also grassland, meadow, village_green, garden, allotments
@scrub: @s-l;        // Lch(84,24,122)
@forest: @s-l;       // Lch(80,30,135)
@forest-text: @s-l;  // Lch(40,30,135)
@park: @s-l;         // Lch(94,30,145)
@allotments: @s-l;   // Lch(87,20,135)
@orchard: @s-l; // also vineyard, plant_nursery
...
@rest_area: @s-l; // also services

// --- Other ----

@bare_ground: @s-l;
@campsite: @s-l; // also caravan_site, picnic_site
@cemetery: @s-l; // also grave_yard
@construction: @s-b; // also brownfield
@heath: @s-b;
@mud: @s-l; // produces #e6dcd1 over @land
@place_of_worship: @s-b; // also landuse_religious
@place_of_worship_outline: darken(@place_of_worship, 30%);
@leisure: lighten(@park, 1%);
@power: darken(@industrial, 5%);
@power-line: darken(@industrial-line, 5%);
@sand: @s-l;
@societal_amenities: @s-l;   // Lch(99,13,109)
@tourism: @s-b;
@quarry: @s-l;
@military: @s-b;
@beach: @s-l;
...
@pitch: @s-l;           // Lch(85,22,168) also track
@track: @pitch;
