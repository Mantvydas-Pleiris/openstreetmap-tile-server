@marina-text: @s-t; // also swimming_pool
@wetland-text: @s-t; /* Also for marsh and mud */
@shop-icon: @s-i;
@shop-text: @s-t;
@transportation-icon: @s-i;
@transportation-text: @s-t;
@accommodation-icon: @transportation-icon;
@accommodation-text: @transportation-text;
@airtransport: @s-t; //also ferry_terminal
@health-color: @s-b;
@amenity-brown: @s-b;
@gastronomy-icon: @s-i;
@gastronomy-text: @s-t;
...
#text-point[zoom >= 10] {
  ...
  [feature = 'tourism_viewpoint'][zoom >= 16] {
    ...
    text-line-spacing: @standard-line-spacing-size;
    text-fill: @s-t;
    [feature = 'natural_volcano'] { text-fill: @s-t; }
    text-dy: 7;
  ...
  [feature = 'tourism_information']["information"='office'][zoom >= 17] {
      ...
      text-line-spacing: @standard-line-spacing-size;
      text-fill: @s-t;
      [information = 'office'] { text-fill: @s-t; }
      text-face-name: @standard-font;
      text-halo-radius: @standard-halo-radius;
      text-halo-fill: @s-to;
      text-placement: interior;
